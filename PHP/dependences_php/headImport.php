                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ($activePage == 'contact') ? 'active' : ''; ?>"
                                ...
                                <img src="../Images/iconsWebShop/shoppingcart.png" style="width: 30px;height: 30px"
                                    alt="Shopping cart">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ($activePage == 'contact') ? 'active' : ''; ?>"
                                href="myOrders.php">My orders</a>
                        </li>

                        <li class="nav-item">
                          <a class="nav-link <?= ($activePage == 'contact') ? 'active' : ''; ?>" href="logout.php">Log
                                out</a>
                        </li>
